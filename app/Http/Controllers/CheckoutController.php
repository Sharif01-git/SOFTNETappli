...
class CheckoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach (Cart::content() as $product) {
            $products['product_' . $i][] = $product->model->nommat;
    ...
    public function thankyou(){
        return Session::has('success') ? view('checkout.thankyou') : redirect()->route('Layout.base');
    }
    ...
    public function getPost(){
        ...
        $pdf = PDF::loadView('checkout.download', ['num'=>$num,'products'=>$products,'date'=>$date,'montant'=>$montant, 'nom'=>$nom ]);
