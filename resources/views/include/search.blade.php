		...
		<nav id="navigation">
			...
			<div class="container">
				...
				<div id="responsive-nav">
                    ...
                    <li><a href="{{route('include.store', ['categorie' => $category->slug])}}">{{$category->nom}}</a></li>
                        @endforeach
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-body">
										...
										<h4 class="product-price">{{$product -> getprix()}}</h4>
										<div class="product-rating">
										</div>
										<div class="product-btns">
											<button class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">add to wishlist</span></button>
											<button class="add-to-compare"><i class="fa fa-exchange"></i><span class="tooltipp">add to compare</span></button>
											<button class="quick-view"><a href="{{ route('include.show', $product->slug) }}"><i class="fa fa-eye"></i><span class="tooltipp">Détais</span></a></button>
										</div>
									</div>
