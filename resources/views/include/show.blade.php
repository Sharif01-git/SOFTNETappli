	...
	<head>
		...
		<title>Produit</title>
         ...
         <script>
            ...
            thumbnails.forEach((element)=>element.addEventListner('click', changeImage));
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							<li><a href="{{route('Layout.base')}}">Home</a></li>
							<li><a href="#">All Categories</a></li>
							<li><a href="#">Accessories</a></li>
							<li><a href="#">Headphones</a></li>
                        <li class="active">{{$product->nommat}}</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">{{$product->nommat}}</h2>
							<div>
							...
							<div>
								<h3 class="product-price">{{$product->getprix()}}</h3>
                            <span class="product-available">{{$stock}}</span>
							</div>
							<p>{!!$product->caractmat!!}</p>
                            ...
                            @if ($stock === 'Disponible')
                                <form action="{{route('cart.store')}}" method="POST">
                                    ...
                                    <input type="hidden" name="nommat" value="{{$product->nommat}}">
